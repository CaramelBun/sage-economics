...
exports.execute = async (client, message, args) => {
  ...
  if (!isBalanceEnough) return message.reply("Your balance is insufficient. You need <:sagecoin:891709800914751508> "+hasItem.cost+" to buy this item.");
  ...
  return message.channel.send(`You purchased **${item}** for **<:sagecoin:891709800914751508> ${hasItem.cost}**.`);
};
